...
- ⬜️ On mahdollista myös kirjautua sisään admin-käyttäjänä.
- ⬜️ Admin-käyttäjä hallitsee sovelluksen sisältöä poistamalla ilmoituksia, jotka vaikka loukkaavat käyttönotton sääntöjä.
...
- ⬜️ Ilmoituksia voi selata myös käyttäen sorttausta ja luokittelua. 
