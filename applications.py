...
def get_applications_for_publisher(publisher_id):
    result = db.session.execute(
        f"SELECT a.id, a.message, a.created_on, n.title as notification_title, n.description as notification_description, u.name as user_name, u.email as user_email "
